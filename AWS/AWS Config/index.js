...
// 하기 설정 부분이 메인 포인트 (모든 리소스를 확인하고 , Rule Resource 를 통해서 구분한다는 정의
...
/*   if (configurationItem.resourceType == 'AWS::EC2::SecurityGroup' ) {
        return 'COMPLIANT';
    } else if (configurationItem.resourceType == 'AWS::IAM::User') {
        return 'COMPLIANT';
    } else if (configurationItem.resourceType == 'AWS::IAM::Group') {
        return 'COMPLIANT';
    } else if (configurationItem.resourceType == 'AWS::IAM::Role') {
        return 'COMPLIANT';
    } else if (configurationItem.resourceType == 'AWS::IAM::Policy') {
        return 'COMPLIANT';
*/    
    return 'COMPLIANT';
}
